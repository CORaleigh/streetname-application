...
const StreetRulesDialog: React.FC<IntroProps> = ({ open, onClose }) => {
  return (
    <calcite-dialog open={open} heading="Street Naming Rules" oncalciteDialogClose={onClose} modal>
      <calcite-list label={"Street Rules"} interactionMode="static" numberingSystem="arab">
